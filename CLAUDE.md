...
### knowledge/ ディレクトリ
技術的な知見やアーキテクチャの説明など、永続的に保持すべきドキュメントは `knowledge/` ディレクトリ内で管理する。

#### 基本ルール
- **Git管理対象**: コミットして履歴管理する
- **永続的なドキュメント**: アーキテクチャ、設計思想、技術的な知見など
- **日付管理**: タイトルの次の行に作成日と最終更新日を記載
...
#### 更新ルール
- **ドキュメントを更新するたびに「最終更新」の日付を更新する**
- 作成日は変更しない
- 大きな変更の場合は、変更履歴をドキュメント末尾に記載することも検討

#### 使用用途
- **アーキテクチャ設計**: システム構成、技術選定の理由
- **移行記録**: 技術スタックの移行状況や経緯
- **ベストプラクティス**: プロジェクト固有の開発ガイドライン
- **技術調査**: 採用技術の調査結果やメモ
